...
1. Download the `zoom-sdk-windows-5.13.10.13355.zip` code archive from the [Zoom App Marketplace](https://marketplace.zoom.us/docs/sdk/native-sdks/windows/).

2. Unzip the code archive to the `src` directory, so there is a `src/zoom-sdk-windows-5.13.10.13355` path.
